...
urlpatterns = [
    ...
    path('edit_collage_page/<int:collage_id>', views.edit_collage_page),
    path('edit_collage/<int:collage_id>', views.edit_collage),
    ...
    path('add_user_page/<int:collage_id>', views.add_user_page),
    path('add_user/<int:collage_id>/<int:user_id>', views.add_user),
    path('remove_user/<int:collage_id>/<int:user_id>', views.remove_user),
    path('logout', views.logout),
